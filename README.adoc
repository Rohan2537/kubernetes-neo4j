...
If you dont want to do port forwading in the last step, the setup also start a load balancer for the browser and bolt.
Check the url in minikube service for the LoadBalancer url's.
...
| default     | neo4j-public         | http://192.168.99.104:30388    |
|             |                      | http://192.168.99.104:30598    |
| kube-system | kube-dns             | No node port                   |
| kube-system | kubernetes-dashboard | http://192.168.99.104:30000    |
|-------------|----------------------|--------------------------------|
```

One of the url will be browser link for Neo4j Browser, while connecting to the server using browser use the other link and replace `http://` with `bolt://` as the url for connection.
